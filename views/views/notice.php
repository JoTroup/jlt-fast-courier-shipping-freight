...
<div class="notice notice-info sf-notice-nux is-dismissible">
    ...
    <div class="notice-content">
        ...
        <p>To enable <?php echo esc_html($fc_name) ?> features you need to install & activate the WooCommerce plugin.</p>
        <p> <span class="plugin-card-woocommerce">
                <a href="plugins.php" class="activate-now" data-originaltext="Activate WooCommerce" data-name="WooCommerce" data-slug="woocommerce" aria-label="Activate WooCommerce">Activate WooCommerce</a>
            </span>
        </p>
    </div>
</div>
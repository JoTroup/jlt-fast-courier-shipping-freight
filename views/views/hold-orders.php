<?php
global $shippingTypes, $fc_holiday_file_path;

$filters = fc_format_order_filters($_GET);
if (!isHposEnabled()) {
    $filters['fc_order_status'] = 'hold';
    $query = new WC_Order_Query($filters);
} else {
    $customFilter = [];
    $customFilter['fc_order_status'] = 'hold';
        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td><?php echo is_array($packs) ? esc_html(count($packs)) : 1 ?>
                        <?php
